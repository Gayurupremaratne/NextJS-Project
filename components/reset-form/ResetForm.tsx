...
import { loginValidation } from './reset-form-validation';
...
export const ResetForm = () => {
  const { isError, isLoading, mutate: forgotPassword } = useForgotPassword();
      ...
      <div className="flex items-center justify-center">
        <div className="w-full h-1 p-4 space-y-5">
          <Snackbar
            intent="error"
            show={isError}
            snackContent={'Reset Password failed, please try again'}
          />
          <Formik
            initialValues={{ email: '' }}
