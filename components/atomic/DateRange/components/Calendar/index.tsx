...
const Calendar: React.FC<Props> = ({
  ...
  const clickDay = useCallback(
    (day: number, month = date.month() + 1, scopedYear = date.year()) => {
      const fullDay = `${scopedYear}-${month}-${day}`;
      let newStart;
      let newEnd = null;
  ...
  return (
    <div className="w-full md:w-[296px] md:min-w-[296px]">
      <div className="flex items-center space-x-1.5 border border-tints-battleship-grey-tint-5 rounded-[5px] px-2 py-1.5">
        ...
        {!showMonths && !showYears && (
          <div className="flex-none">
            <RoundedButton onClick={onClickNext} roundedFull={true}>
